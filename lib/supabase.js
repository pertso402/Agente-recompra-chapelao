...
export async function buscarMidiaDoDia(data = null) {
  ...
  // Sem upload específico pra hoje: cai no vídeo padrão em vez de não
  // disparar nada. Antes, esquecer de subir o vídeo do dia parava a
  // campanha inteira sem ninguém perceber até checar os logs.
  return buscarMidiaPadrao();
}
