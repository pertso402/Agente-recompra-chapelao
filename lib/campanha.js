...
export const JANELA_INICIO = 9; // 09:00
export const JANELA_FIM = 14; // 14:00
// 22 aqui + até 8 do gatilho pós-primeira-compra = 30/dia no chip de disparo,
// que é o teto que o dono definiu. Os dois fluxos compartilham o MESMO número,
// então a conta que importa é a soma — olhar só pra este número esconderia o
// volume real saindo do chip.
export const META_DIARIA = 22;
...
//
// 22 msgs em 5h (300min) exige ~1 a cada 14min na média, bem mais folgado que
// as 40 em 4h15 de antes. O cron decide a cada 5min (grid fixo), então o piso
// de 5min continua sendo o menor espaçamento possível — e agora ele quase
// nunca é o limitante, porque o ritmo alvo já é o dobro disso. Com meta 40 o
// piso era o gargalo (piso 5.1 já derrubava o alcançável pra ~25); com 25 há
// folga real pra jitter sem ameaçar a meta.
